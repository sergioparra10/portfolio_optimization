...
### Data modeling Tiny RL (Monthly basis with three month data training)
### Sergio Parra 
### sparrap@itam.mx
...
for i in all_stocks:
    ...
    for i in range(len(months) - 2):
       previous_two_month = months[i-2]
       previous_month = months[i-1]
       current_month = months[i]
       next_month = months[i+1]
       next_two_month = months[i+2]

       x_train = df_stock.loc[df_stock['month'].isin([previous_two_month,previous_month,current_month])].rets
...
df_train_returns.to_csv("03_Output/df_train_returns_threemonth.csv", encoding='utf-8', index=True)
df_train_hold.to_csv("03_Output/df_train_hold_threemonth.csv", encoding='utf-8', index=True)
df_test_returns.to_csv("03_Output/df_test_returns_threemonth.csv", encoding='utf-8', index=True)
df_test_hold.to_csv("03_Output/df_test_hold_threemonth.csv", encoding='utf-8', index=True)
df_sharpes.to_csv("03_Output/df_sharpes_threemonth.csv", encoding='utf-8', index=True)
df_thetas.to_csv("03_Output/df_thetas_threemonth.csv", encoding='utf-8', index=True)
