...
### Data modeling Lasso, cumulative month training
### Sergio Parra 
### sparrap@itam.mx
...
df_all.to_csv("03_Output/df_coeff_lasso_complete_monthly.csv", encoding='utf-8', index=True)
